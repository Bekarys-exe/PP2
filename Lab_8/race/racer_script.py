...
road = pygame.image.load("Lab_8/race/road.png")
player = pygame.image.load("Lab_8/race/WhiteStrip.png")
enemys = [
    pygame.image.load("Lab_8/race/BlackOut.png"),
    pygame.image.load("Lab_8/race/BlueStrip.png"),
    pygame.image.load("Lab_8/race/GreenStrip.png"),
    pygame.image.load("Lab_8/race/PinkStrip.png"),
    pygame.image.load("Lab_8/race/RedStrip.png")
]
coin = pygame.image.load("Lab_8/race/coin_16x16.png")
sound_icon = [pygame.image.load("Lab_8/race/unmute_s.png"), pygame.image.load("Lab_8/race/mute_s.png")]
music_icon = [pygame.image.load("Lab_8/race/unmute_m.png"), pygame.image.load("Lab_8/race/mute_m.png")]

# Загрузка и воспроизведение фоновой музыки в бесконечном цикле
pygame.mixer.music.load("Lab_8/race/MAX-COVERI-RUNNING-IN-THE-90S-頭文字D-INITIAL-D.mp3")
pygame.mixer.music.play(-1)

# Загрузка звуковых эффектов
sounds = [
    pygame.mixer.Sound("Lab_8/race/mixkit-retro-arcade-game-over-470.wav"),  # Звук проигрыша
    pygame.mixer.Sound("Lab_8/race/mixkit-winning-a-coin-video-game-2069.wav")  # Звук подбора монеты
]
        ...
        if self.y < 464:
            ...
            if not self.coin_collected:
                ...
                if (284 <= self.y <= 364) and (player_pos - 8 <= 103 * self.m_row + 37 <= player_pos + 40):
                    ...
                    sounds[1].play()
                    coin_score += 1  # Увеличиваем счёт монет
        else:
            # Респавн врага
            self.__init__()
